...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      {watchDirectory && (
        <div className="fixed top-0 left-0 right-0 bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-2 z-10">
                      <div className="container mx-auto">
              <div className="flex gap-6 justify-between items-center">
                <div className="flex-1">
                  <div className="flex gap-2 items-center max-w-md">
                    <div className="text-sm text-gray-700 dark:text-gray-300 font-medium text-left">
                      Directory: {watchDirectory}
                    </div>
                    <button
                      onClick={() => setIsConfigEditorOpen(true)}
                      className="p-1 text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded transition-colors"
      ...
      <div className={`container mx-auto py-10 ${watchDirectory ? 'pt-16' : ''}`}>
        <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">File List</h1>
        ...
        <div>
          ...
          <div className="mb-6">
            <div className="flex gap-2 max-w-md">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
              <button
                onClick={handleSearch}
                disabled={isSearching}
                className="px-4 py-2 bg-blue-500 dark:bg-blue-600 text-white rounded-md hover:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            {searchTerm && searchResults.length === 0 && !isSearching && (
              <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md">
                <p className="text-sm text-gray-600 dark:text-gray-400">No files found containing "{searchTerm}"</p>
              </div>
            )}
          </div>
          ...
          <Table className="table-fixed w-full">
            <TableHeader>
              <TableRow>
                <TableHead 
                  className="text-center w-1/6 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                ...
                <TableHead 
                  className="text-center w-1/6 pl-14 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                  ...
                  <TableCell className="w-1/6 text-center">
                    <div className="flex justify-center gap-2">
                      ...
                      {!file.transcript && !currentProcessingFile.includes(file.name) && (
                        <div className="p-2 text-red-600 dark:text-red-400" title="No transcript available">
                      ...
                      {file.transcript ? (
                        <>
                          <button
                            ...
                            className={`p-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                          ...
                          <button
                            ...
                            className={`p-2 text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed`}
                        ...
                        <button
                          disabled={true}
                          className="p-2 text-gray-600 dark:text-gray-400 opacity-50 cursor-not-allowed rounded-md"
