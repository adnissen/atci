...
const ConfigSetup: React.FC<ConfigSetupProps> = ({ onConfigComplete, isEditMode = false }) => {
  ...
  const renderForm = () => (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="watch_directory" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          Watch Directory
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="whispercli_path" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          Whisper CLI Path
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="model_path" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          Model Path
        </label>
        <input
          type="text"
      ...
      <div className="flex space-x-3">
        ...
        {hasAllConfigValues() && (
          <button
            ...
            disabled={isSubmitting}
            className="flex-1 bg-gray-600 dark:bg-gray-700 text-white py-2 px-4 rounded-md hover:bg-gray-700 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
        )}
