    ...
    <div className={`mb-2 ${isSearchResult ? 'bg-yellow-50 dark:bg-yellow-950/20 border-l-4 border-yellow-400 dark:border-yellow-600 pl-2' : ''}`}>
      <div className="grid grid-cols-12 gap-1">
        ...
        <div className="col-span-12 flex items-center -mt-1">
          ...
          <span className="inline-flex items-center cursor-pointer text-muted-foreground group transition-colors ml-2">
            <button 
              onClick={handleEdit}
              className="inline-flex items-baseline p-0 border-none bg-transparent"
              title="Edit this line"
            >
              <Edit2 size={16} className="group-hover:stroke-[#3b82f6]" />
            </button>
          </span>
        </div>
      </div>
