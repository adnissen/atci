defmodule Atci.WhisperCliManager do
  @moduledoc """
  ...
  def get_current_path(tool) do
    ...
    config_path = Atci.ConfigManager.get_config_value("whispercli_path")
  ...
  def set_tool_path("whisper-cli" = tool, path) do
    current_config = Atci.ConfigManager.get_config()
    # Use whispercli_path to maintain compatibility with existing config
    updated_config = Map.put(current_config, "whispercli_path", path)
    Atci.ConfigManager.save_config(updated_config)
  end
