defmodule Atci.PathHelper do
  ...
  ## Examples
      iex> Atci.PathHelper.video_wildcard_pattern()
      "{mp4,MP4}"
  """
  ...
  ## Examples
      iex> Atci.PathHelper.video_extensions_with_dots()
      [".mp4", ".MP4"]
  """
  ...
  ## Examples
      iex> Atci.PathHelper.find_video_file("/path/to/videos", "myvideo")
      "/path/to/videos/myvideo.mp4"

      iex> Atci.PathHelper.find_video_file("/path/to/videos", "nonexistent")
      nil
  """
  ...
  ## Examples
      iex> Atci.PathHelper.video_file_exists?("/path/to/videos", "myvideo")
      true

      iex> Atci.PathHelper.video_file_exists?("/path/to/videos", "nonexistent")
      false
  """
  ...
  ## Examples
      iex> Atci.PathHelper.find_txt_file_from_video("/path/to/videos/myvideo.mp4")
      "/path/to/videos/myvideo.txt"

      iex> Atci.PathHelper.find_txt_file_from_video("/path/to/videos/nonexistent.mp4")
      nil
  """
  ...
  ## Examples
      iex> Atci.PathHelper.find_meta_file_from_video("/path/to/videos/myvideo.mp4")
      "/path/to/videos/myvideo.meta"

      iex> Atci.PathHelper.find_meta_file_from_video("/path/to/videos/nonexistent.mp4")
      nil
  """
  ...
  ## Examples
      iex> Atci.PathHelper.find_mp3_file_from_video("/path/to/videos/myvideo.mp4")
      "/path/to/videos/myvideo.mp3"

      iex> Atci.PathHelper.find_mp3_file_from_video("/path/to/videos/nonexistent.mp4")
      nil
  """
