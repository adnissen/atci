defmodule Atci.TranscriptModifier do
  @moduledoc """
  ...
  ## Examples
      iex> Atci.TranscriptModifier.add_source_to_meta("/path/to/transcript.txt")
      :ok
  """
  ...
  def get_model_filename do
    case Atci.ConfigManager.get_config_value("model_path") do
      nil ->
  ...
  defp update_meta_file_source(transcript_path, model_filename) do
    ...
    case Atci.MetaFileHandler.update_meta_field(meta_path, "source", model_filename) do
      :ok ->
        :ok
